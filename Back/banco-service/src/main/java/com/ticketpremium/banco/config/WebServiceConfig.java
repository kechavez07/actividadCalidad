package com.ticketpremium.banco.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema bancoSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://ticketpremium.com/banco/ws");
    ...
    public XsdSchema bancoSchema() {
        return new SimpleXsdSchema(new ClassPathResource("schemas/banco.xsd"));
    }
}
