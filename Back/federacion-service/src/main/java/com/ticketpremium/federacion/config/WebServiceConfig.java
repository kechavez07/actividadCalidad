package com.ticketpremium.federacion.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema federacionSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://ticketpremium.com/federacion/ws");
    ...
    public XsdSchema federacionSchema() {
        return new SimpleXsdSchema(new ClassPathResource("schemas/federacion.xsd"));
    }
}
